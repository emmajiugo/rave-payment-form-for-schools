...
var inputs = document.querySelectorAll('.rave-form select, .rave-form input[type="text"], .rave-form input[type="datepicker"], .rave-form input[type="file"], .rave-form input[type="textarea"], .rave-form input[type="password"], .rave-form input[type="email"], .rave-form input[type="number"]');
...
if (inputs) {
    for (var i = 0; i < inputs.length; i++) {
    	if (inputs[i].value != '') {
            inputs[i].previousElementSibling.classList.add('label-active');
        }
